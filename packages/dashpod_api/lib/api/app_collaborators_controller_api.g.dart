...
part of 'app_collaborators_controller_api.dart';
...
class _AppCollaboratorsControllerApi implements AppCollaboratorsControllerApi {
  _AppCollaboratorsControllerApi(this._dio, {this.baseUrl, this.errorLogger});
