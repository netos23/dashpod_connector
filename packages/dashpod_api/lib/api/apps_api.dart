...
abstract class AppsApi {
  ...
  @GET('/api/v1/apps')
  Future<GetAppsResponseDto> listApps();

  @POST('/api/v1/apps')
  Future<AppDto> createApp(@Body() CreateAppRequestDto createAppRequestDto);

  @DELETE('/api/v1/apps/{appId}')
  Future<dynamic> deleteApp(@Path('appId') String appId);
}
