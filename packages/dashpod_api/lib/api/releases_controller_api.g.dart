...
part of 'releases_controller_api.dart';
...
class _ReleasesControllerApi implements ReleasesControllerApi {
  _ReleasesControllerApi(this._dio, {this.baseUrl, this.errorLogger});
